...
class BrainMapCompiler {
    ...
    static final String BRAINMAP_FIELD = "\$BRAINMAP"
    static final String CALLER_NAME = Caller.class.getName().replace('.','/')
    static final String BRAINMAP_FIELD_DESC = "[L${CALLER_NAME};"
    static final String OBJECT_NAME = Object.class.getName().replace('.','/')
    static final String CALLER_PREFIX = "\$brainfrickCaller\$"
    static final String LIST_NAME = List.class.name.replace('.','/')
    static final String CALLER_DESC = "(L${LIST_NAME};)L${OBJECT_NAME};"
    static final String INIT_NAME = "<init>"
    static final String BUFFER_UTILS_NAME = InvocationUtils.class.getName().replace('.','/')
    static final String CHECK_ENOUGH = "checkEnough"
    static final String CHECK_ENOUGH_DESC = "(II)V"
    static final String LAMBDAMETAFACTORY_NAME = LambdaMetafactory.class.name.replace('.','/')
    static final String METAFACTORY_DESC = "(Ljava/lang/invoke/MethodHandles\$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;" +
    ...
    static void writeClassCaller(BrainMap.BrainType type, MethodVisitor mv) {
        mv.visitCode()
        mv.visitLdcInsn(Type.getType("L"+type.type.names.join('/')+';'))
        mv.visitInsn(Opcodes.ARETURN)
        mv.visitMaxs(-1,-1)
        mv.visitEnd()
    }
